...
class OrbitController implements CameraController {
    ...
    constructor(orbitSettings?: OrbitSettings) {
        this.controller = new OrbitControllerPC();
        this.controller.zoomRange = new Vec2(0.01, orbitSettings?.maxDistance ?? Infinity);
        this.controller.pitchRange = new Vec2(orbitSettings?.minPitch ?? -90, 90);
