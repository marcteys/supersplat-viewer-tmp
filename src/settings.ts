...
const migrateV2 = (v1: V1): V2 => {
    return {
        ...
        background: {
            ...
            skyboxUrl: v1.skybox?.url,
            skyboxProjection: v1.skybox?.projection,
            skyboxScale: v1.skybox?.scale,
            skyboxCenter: v1.skybox?.center
        },
        postEffectSettings: {
            sharpness: {
                enabled: false,
        ...
        annotations: [],
        orbitSettings: v1.orbitSettings,
...
export type { AnimTrack, Camera, Annotation, PostEffectSettings, OrbitSettings, ExperienceSettings } from './schemas/v2';
